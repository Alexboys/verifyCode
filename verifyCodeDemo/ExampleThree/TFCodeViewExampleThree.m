...
@interface TFCodeViewExampleThree ()
...
@property (nonatomic, strong) NSMutableArray<GXTC_lineView *> *lines;
...
@implementation TFCodeViewExampleThree
...
- (void)configTextField
{
    ...
    for (NSInteger i = 0; i < self.itemCount; i++)
    {
        GXTC_lineView *line = [GXTC_lineView new];
