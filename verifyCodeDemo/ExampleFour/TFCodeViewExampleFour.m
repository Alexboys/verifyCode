...
@interface TFCodeViewExampleFour ()
...
@property (nonatomic, strong) NSMutableArray<GXCursorLabel *> *labels;

@property (nonatomic, strong) NSMutableArray<UIView *> *lines;

@property (nonatomic, weak) GXCursorLabel *currentLabel;

@end

@implementation TFCodeViewExampleFour
...
- (void)configTextField
{
    ...
    {
        GXCursorLabel *label = [GXCursorLabel new];
...
- (void)cursor
{
    ...
    GXCursorLabel *label = [self.labels objectAtIndex:index];
